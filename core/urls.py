...
urlpatterns = [
    ...
    path("activities/<uuid:pk>/grade-student/", ActivityStudentGradeView.as_view(), name="activity-student-grade"),
    ...
    path("advisory/<uuid:section_id>/subject-reminders/", AdvisorySubjectReminderView.as_view(), name="advisory-subject-reminders"),
    ...
    path("course-sections/<uuid:pk>/grades/bulk-take-back-final/", BulkTakeBackFinalGradesView.as_view(), name="grades-bulk-take-back-final"),
    ...
    path("advisory/<uuid:section_id>/report-card/sf9/export/", AdvisorySF9ExportView.as_view(), name="advisory-sf9-export"),
